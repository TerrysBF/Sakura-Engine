...
// Actualiza el constant buffer por frame con datos de c�mara y luz
void
...
// Renderiza todos los objetos opacos usando el shadow map si est� disponible
void
...
// Calcula las matrices de vista y proyecci�n desde la perspectiva de la luz
void
