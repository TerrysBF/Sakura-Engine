\chapter{EXAMPLES}
\hypertarget{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s}{}\label{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s}\index{EXAMPLES@{EXAMPLES}}
{\itshape (You may browse this at \href{https://github.com/ocornut/imgui/blob/master/docs/EXAMPLES.md}{\texttt{ https\+://github.\+com/ocornut/imgui/blob/master/docs/\+EXAMPLES.\+md}} or view this file with any Markdown viewer)}\hypertarget{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s_autotoc_md40}{}\doxysubsection{\texorpdfstring{Dear Im\+Gui\+: Examples}{Dear Im\+Gui\+: Examples}}\label{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s_autotoc_md40}
{\bfseries{The \href{https://github.com/ocornut/imgui/blob/master/examples}{\texttt{ examples/}} folder example applications (standalone, ready-\/to-\/build) for variety of platforms and graphics APIs.}} They all use standard backends from the \href{https://github.com/ocornut/imgui/blob/master/backends}{\texttt{ backends/}} folder (see \href{https://github.com/ocornut/imgui/blob/master/docs/BACKENDS.md}{\texttt{ docs/\+BACKENDS.\+md}}).
...
You can find Windows binaries for some of those example applications at\+: \href{https://www.dearimgui.com/binaries}{\texttt{ https\+://www.\+dearimgui.\+com/binaries}}\hypertarget{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s_autotoc_md41}{}\doxysubsubsection{\texorpdfstring{Getting Started}{Getting Started}}\label{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s_autotoc_md41}
...
If you are using any of the backends provided here, you can add the backends/imgui\+\_\+impl\+\_\+xxxx(.cpp,.h) files to your project and use as-\/in. Each imgui\+\_\+impl\+\_\+xxxx.\+cpp file comes with its own individual Changelog, so if you want to update them later it will be easier to catch up with what changed.\hypertarget{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s_autotoc_md42}{}\doxysubsubsection{\texorpdfstring{Examples Applications}{Examples Applications}}\label{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s_autotoc_md42}
...
\href{https://github.com/ocornut/imgui/tree/master/examples/example_apple_metal/}{\texttt{ example\+\_\+apple\+\_\+metal/}} ~\newline
...
\href{https://github.com/ocornut/imgui/blob/master/examples/example_glfw_wgpu/}{\texttt{ example\+\_\+glfw\+\_\+wgpu/}} ~\newline
 GLFW + Web\+GPU example. Supports Emscripten (web), Dawn (native), WGPU (native). ~\newline
...
\href{https://github.com/ocornut/imgui/blob/master/examples/example_null/}{\texttt{ example\+\_\+null/}} ~\newline
 ...
 = main.\+cpp + \doxylink{imgui__impl__null_8cpp_source}{imgui\+\_\+impl\+\_\+null.\+cpp}~\newline
 This is used to quickly test compilation of core imgui files in as many setups as possible. Because this application doesn\textquotesingle{}t create a window nor a graphic context, there\textquotesingle{}s no graphics output. Please note that imgui\+\_\+impl\+\_\+null itself is a rather empty backend. We provide it for consistency but it is similarly easy to create a skeleton application without the null backend.
...
\href{https://github.com/ocornut/imgui/blob/master/examples/example_sdl2_wgpu/}{\texttt{ example\+\_\+sdl2\+\_\+wgpu/}} ~\newline
 SDL2 + Web\+GPU example. Supports Emscripten (web), Dawn (native), WGPU (native). ~\newline
 = main.\+cpp + imgui\+\_\+impl\+\_\+sdl2.\+cpp + imgui\+\_\+impl\+\_\+wgpu.\+cpp (note that the \textquotesingle{}example\+\_\+sdl2\+\_\+opengl3\textquotesingle{} example also supports Emscripten!)

\href{https://github.com/ocornut/imgui/blob/master/examples/example_sdl3_directx11/}{\texttt{ example\+\_\+sdl3\+\_\+directx11/}} ~\newline
 SDL3 + Direct\+X11 examples, Windows only. ~\newline
 = main.\+cpp + imgui\+\_\+impl\+\_\+sdl3.\+cpp + imgui\+\_\+impl\+\_\+dx11.\+cpp ~\newline


\href{https://github.com/ocornut/imgui/blob/master/examples/example_sdl3_metal/}{\texttt{ example\+\_\+sdl3\+\_\+metal/}} ~\newline
 SDL3 + Metal example, Mac only. ~\newline
 = main.\+cpp + imgui\+\_\+impl\+\_\+sdl3.\+cpp + imgui\+\_\+impl\+\_\+metal.\+mm ~\newline
...
\href{https://github.com/ocornut/imgui/blob/master/examples/example_sdl3_wgpu/}{\texttt{ example\+\_\+sdl3\+\_\+wgpu/}} ~\newline
 SDL3 + Web\+GPU example. Supports Emscripten (web), Dawn (native), WGPU (native). ~\newline
 = main.\+cpp + imgui\+\_\+impl\+\_\+sdl3.\+cpp + imgui\+\_\+impl\+\_\+wgpu.\+cpp (note that the \textquotesingle{}example\+\_\+sdl3\+\_\+opengl3\textquotesingle{} example also supports Emscripten!)
...
\hypertarget{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s_autotoc_md43}{}\doxysubsubsection{\texorpdfstring{Miscellaneous}{Miscellaneous}}\label{md_imgui-docking_2docs_2_e_x_a_m_p_l_e_s_autotoc_md43}
{\bfseries{Building}}
